...
import (
	...
	types "github.com/ovotech/go-sync/pkg/types"
)

// MockConfigFn is an autogenerated mock type for the ConfigFn type
type MockConfigFn[T types.Adapter] struct {
	mock.Mock
}

type MockConfigFn_Expecter[T types.Adapter] struct {
	mock *mock.Mock
}
...
type MockConfigFn_Execute_Call[T types.Adapter] struct {
	*mock.Call
}
...
func NewMockConfigFn[T types.Adapter](t interface {
	mock.TestingT
	Cleanup(func())
}) *MockConfigFn[T] {
	mock := &MockConfigFn[T]{}
