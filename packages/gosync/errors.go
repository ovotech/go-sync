...
// ErrNotImplemented is for brand-new packages that are still being worked on.
//
...
// ErrReadOnly is returned for packages that cannot Add/Remove, but have been set as a destination.
